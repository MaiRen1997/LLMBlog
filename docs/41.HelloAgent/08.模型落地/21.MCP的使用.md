...
1. 用来引入自定义的MCP server,也可以使用其他人上传的MCP
   ...
   2. 加载之后，会显示状态
      ...
      **如果还是加载不成功，可以先在命令行，直接运行命令预先下载，然后再重新加载**
      ...
      ![](./img/MCPLoadStatus.png)

2. 启动流程

   ![](./img/ClineProcess.png)
