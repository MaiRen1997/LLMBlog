---
title: MCP(系统笔记)
date: 2026-04-11 08:28:49
permalink: /pages/eaefd2/
categories:
  - Agent学习
  - MCP的使用
tags:
...
1. 使用`FastMCP("Demo"， host="0.0.0.0", port=8000)`定义名称、IP、端口号
   ...
   2. 如果是stdio，则不需要指定
      通过**本地进程**(stdio)通信。Client 启动 Server 为子进程，两者通过标准输入输出流传递数据
