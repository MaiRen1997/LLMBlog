---
title: Python调用Coze平台工作流
date: 2026-04-10 23:53:30
permalink: /pages/5f321a/
categories:
  - Agent学习
  - Coze&Dify工作流的使用
tags:
...
![image-20250813145826661](./deployCoze/image-20250813145826661.png)
...
![image-20250813150058212](./deployCoze/image-20250813150058212.png)
...
![image-20250813150925985](./deployCoze/image-20250813150925985.png)

### 2.3 授权API key

左侧窗口下滑，可以看到token，这就是API Key，点击授权

![image-20250813151145365](./deployCoze/image-20250813151145365.png)

点击“授权”后自动生成并填充 API Key

![image-20250813151323753](./deployCoze/image-20250813151323753.png)
...
![image-20250813151718254](./deployCoze/image-20250813151718254.png)

### 2.5 运行

可以直接点击Shell命令窗口右上角的“运行”按钮

![image-20250813151931238](./deployCoze/image-20250813151931238.png)
...
![image-20250813152407941](./deployCoze/image-20250813152407941.png)
...
![image-20250813152519965](./deployCoze/image-20250813152519965.png)

此处的content是工作流的输出。

Done是最后一个响应，表示工作流执行完毕，在Message响应之后。

![image-20250813152856481](./deployCoze/image-20250813152856481.png)

## 3.通过python代码调用工作流

### 3.1 官方提供了调用API的Python代码

![image-20250813153047412](./deployCoze/image-20250813153047412.png)
...
![image-20250815014406971](./deployCoze/image-20250815014406971.png)

需要补充代码：

![image-20250815014227105](./deployCoze/image-20250815014227105.png)
...
![image-20250815014200569](./deployCoze/image-20250815014200569.png)
...
![image-20250813154738952](./deployCoze/image-20250813154738952.png)
