---
title: 接入OpenAI_Agents_SDK源文件
date: 2026-05-08 13:01:05
permalink: /pages/cd3833/
categories:
  - 项目总结
  - ITS多智能体
tags:
...
**Tool（工具）**是智能体（Agent）可以调用的外部函数，让AI能够执行特定任务，如查询天气、搜索信息、计算数据等。
...
| 方式                                            | 作用范围                    | 适用场景                  |
| ----------------------------------------------- | --------------------------- | ------------------------- |
| **方式一`set_default_openai_client`：全局设置** | 所有 Agent 共享同一个客户端 | 单模型项目                |
