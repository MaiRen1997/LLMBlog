---
title: 同步与异步编程
date: 2026-04-05 12:54:24
permalink: /pages/0773ea/
categories:
  - FastAPI
  - asyncio的使用
tags:
...
async def demo_async_programming():
    ...
    print(f"结果: {results}")Copy to clipboardErrorCopied
```
...
开始执行 文件读取...
文件读取 完成！
同步编程总耗时: 6.01 秒Copy to clipboardErrorCopied
```
...
网络请求 完成！
文件读取 完成！
异步编程总耗时: 2.00 秒Copy to clipboardErrorCopied
```
