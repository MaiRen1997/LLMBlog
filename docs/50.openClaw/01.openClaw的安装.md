---
title: openClaw的安装
date: 2026-03-06 14:22:26
permalink: /pages/eb4aa5/
categories:
  - openClaw
tags:
  - 
...
**注意：**技能默认注册表为 https://clawhub.com，可通过 `CLAWHUB_REGISTRY` 环境变量或 `--registry` 参数覆盖。
...
**永远不要**在未经保护的情况下公开 DM：
使用 `dmPolicy: "pairing"` 或 `allowlist` 而非 `open`
